...
public class TwitchClient {
    private static final String TOKEN = "Bearer yqqqwgjwnx332wqaydapoaue397n89";
    private static final String CLIENT_ID = "oor883xb73t2hliirhl4ag1d0pzutn";
    ...
    public Game searchGame(String gameName) throws TwitchException {
        List<Game> gameList = getGameList(searchTwitch(
                buildGameUrl(GAME_SEARCH_URL_TEMPLATE, gameName, 0)));
        if (gameList.size() != 0) {
